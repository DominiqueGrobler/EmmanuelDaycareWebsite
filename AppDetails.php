<?php
    ...
    if(isset( $_POST['del'] ) )
    {
      ...
      $query = "DELETE FROM tblapplication WHERE ApllicationID ='".$_SESSION['appID']."' ;";
    ...
    if (isset($_SESSION['appID']))
    {
		...
		$sql = "SELECT * FROM tblapplication WHERE ApllicationID ='".$_SESSION['appID']."' ;";
      ...
      //doc detais
         ...
         //em1 details
         $emName1 = $row['emName1'];
         $emSurname1 = $row['emSurname1'];
         $emCell1 = $row['emCell1'];
         $emAddress1 = $row['emAddress1'];
     
         //em2 details
         $emName2 = $row['emName2'];
         $emSurname2 = $row['emSurname2'];
         $emCell2 = $row['emCell2'];
         $emAddress2 = $row['emAddress2'];
     
         //textFields
         $cAllergies = $row['cAllergies'];
         $cOperations = $row['cOperations'];
      ...
      <form action="AppDetails.php" method="post">
        ...
        <div class="item">
         ...
         <input type="checkbox" name="dNot"/> <span style="color:#7E0272">Check if the second parent is not applicable</span>
          ...
          <input type="text" value="<?php echo $dEmail; ?>"/>
        </div>
        </br>
        ...
        <div class="item">
          ...
          <div class="name-item">
            <input type="text" value="<?php echo $docName; ?>" />
            <input type="text" value="<?php echo $docNum; ?>" />
        </div>
        
        <div class="item">
          <p style="color:#7E0272";><B>EMERGENCY CONTACT 1</B></p>
          <div class="name-item">
            <input type="text" value="<?php echo $emName1; ?>"/>
            <input type="text" value="<?php echo $emSurname1; ?>"/>
          <input type="text" value="<?php echo $emCell1; ?>"/>
          <input type="text" value="<?php echo $emAddress1; ?>" />
        </div>
        
        <div class="item">
          <p style="color:#7E0272";><B>EMERGENCY CONTACT 2</B></p>
          <div class="name-item">
          <input type="text" value="<?php echo $emName2; ?>"/>
            <input type="text" value="<?php echo $emSurname2; ?>"/>
          <input type="text" value="<?php echo $emCell2; ?>"/>
          <input type="text" value="<?php echo $emAddress2; ?>" />
        </div>
        </br>
<div class="item">
        <p style="color:#FF7017";><B>OPERATIONS OR ALLERGIES</B></p>
          <p style="color: #666";>Does your child have any allergies?</p>
          <textarea rows="3"><?php echo $cAllergies; ?></textarea>
        </div>
        <div class="item">
          <p style="color: #666";>Has your child have any operations?</p>
            <textarea rows="3" ><?php echo $cOperations; ?></textarea>
        </div>
