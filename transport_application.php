 ...
 $_SESSION['admin'] = false;
  ...
  $mess = "SELECT * FROM tblmessage";
        ...
        if (isset($_POST['apply']))
    {
		...
		$sql = "INSERT INTO tbltransport (cName, cSurname, cAge, cBdate, cAddress,
    ...
    '$dName', '$dSurname', '$dID','$dOccupation', '$dCell', '$dWork' , '$dEmail')";
		...
		$Error ="New record created successfully". "<br>";
		} else {
...
<html lang="en">
  ...
  <body>
    ...
    <section style="background-color:#97C71B;">
      <div class="testbox">
        <form action="transport_application.php" method="post">
          <p>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <legend style="background-color:#7E0272; text-align: center;"> <b>Applicant Information</b></legend>
          ...
          <div class="name-item">
            ...
            <input type="text" name="cSurname" placeholder="Surname" required/>
          </div>
        </div>
        <div class="item">
          <input type="text" name="cAge" placeholder="Age" required/>
        </div>
        <div class="item">
      ...
      <p style="color:#FF7017";><B>1. PARENTS DETAILS</B></p>
       <label>
         <input type="checkbox" name="mNot"/> <span style="color:#FF7017">Check if the first parent is not applicable</span>
          ...
          <input type="tel" pattern="[0-9]{10}" placeholder="Cellphone number" />
          <input type="text" name="mWork" placeholder="Work number" />
          <input type="email" name="mEmail" placeholder="Email" />
        </div>
       </br>
        <div class="item">
        
          <p style="color:#7E0272";><B>2. PARENTS DETAILS </B></p>
           <label>
         <input type="checkbox" name="dNot"/> <span style="color:#7E0272">Check if the second parent is not applicable</span>
          ...
          <input type="tel" pattern="[0-9]{10}" placeholder="Cellphone number" />
          <input type="text" name="dWork" placeholder="Work number" />
